...
namespace Suche.Controllers
{
    ...
    public class ManagementCompanyController : Controller
    {
        ...
        public ManagementCompanyController(IConfiguration configuration)
        {
        ...
        //[Authorize]
        public async Task<IActionResult> UpdateDocuments([FromBody]UploadManagementCompanyRequest request)
        {
            try
            {
                Debug.WriteLine($"Management Company: {request.ManagementCompany}");
                Search search = new Search(accessKeyId, secretAccessKey, region);
                HttpResponseMessage result = await search.UploadDocumentsAsync<ManagementCompany>(request.ManagementCompany, request.IndexName, domainName);
        ...
        public async Task<IActionResult> Search([FromBody]SearchRequest request)
        {
            try
            {
                ...
                string[] fields = GetFieldsByType<ManagementCompany>(typeof(String));
                ...
                var result = await search.SearchDocumentAsync<ManagementCompany>(searchQuery, domainName);
